...
import com.fc.activity.esp.ArrivalConfirmationActivity;
import com.fc.activity.esp.InformationReceivingRefuseList;
import com.fc.activity.esp.InformationReceivinglist;
import com.fc.activity.esp.InformationReceivinglist_Dzqd;
import com.fc.activity.esp.PGDCaseActivity;
import com.fc.activity.esp.ServiceReportslist;
import com.fc.activity.esp.SheBeiPDActivity;
import com.fc.activity.esp.XjListActivity;
import com.fc.activity.esp.YytReportedActivity;
import com.fc.activity.esp.ZZServiceReportslist;
import com.fc.activity.kc.HpzhActivity;
import com.fc.activity.kc.KccxActivity;
import com.fc.activity.kc.KccxChooseActivity;
import com.fc.activity.kc.KcpdActivity;
import com.fc.activity.kc.KcxxActivity;
import com.fc.activity.kc.SqdActivity;
import com.fc.activity.kc.SqdcxkListActivity;
import com.fc.activity.kc.WbdbckActivity;
import com.fc.activity.kc.WbdbrkListActivity;
import com.fc.activity.kdg.DhjcKdg;
import com.fc.activity.kdg.FwbgKdg;
import com.fc.activity.kdg.FwbgKdgWx;
import com.fc.activity.kdg.FwbgXj;
import com.fc.activity.kdg.JdxyKdg;
import com.fc.activity.kdg.JdxyKdgWx;
import com.fc.activity.kdg.JdxyXj;
import com.fc.activity.kdg.JqgdcxKdg;
import com.fc.activity.kdg.ListKdg;
import com.fc.activity.kdg.SbxxpdActivity;
import com.fc.activity.kdg.ScsbbActivity;
import com.fc.activity.kdg.SmdwKdg;
import com.fc.activity.kdg.SmdwKdgWx;
import com.fc.activity.kdg.SmdwXj;
import com.fc.activity.kdg.Xddwcx;
import com.fc.activity.kdg.ZcdjInfo;
import com.fc.activity.kdg.ZcdjList;
import com.fc.activity.kdg.ZcdjQuery;
import com.fc.activity.kdg.ZcdjSbList;
import com.fc.activity.kdg.Zzpqgdcx;
import com.fc.activity.kdg.ZzzpKdgWx;
import com.fc.activity.login.LoginActivity;
import com.fc.activity.w.ChangePasswordActivity;
import com.fc.activity.w.Fwzxscx;
import com.fc.activity.w.GzpActivity;
import com.fc.activity.w.GzpLrActivity;
import com.fc.activity.w.HelpActivity;
import com.fc.activity.w.JszlActivity;
import com.fc.activity.w.Pqzgjsl;
import com.fc.activity.w.QyxxActivity;
import com.fc.activity.w.XxglActivity;
import com.fc.activity.w.YHKInfoActivity;
import com.fc.activity.w.YhkxxActivity;
import com.fc.cache.DataCache;
import com.fc.cache.ServiceReportCache;
import com.fc.dodowaterfall.MarqueeTextView;
import com.fc.service.CsyyService;
import com.fc.service.MyBroadcastReceiver;
import com.fc.service.NumberService;
import com.fc.utils.AppUtils;
...
//			});
	...
	private void initMenus() {
		...
		js_map.put("id", "m_pad_kdg_zzzp_wx");
		js_map.put("name", "组长转派");
		...
		w_list.add(w_map);
		w_map = new HashMap<String, Object>();
		w_map.put("id", "m_kfgl_hzh");
		w_map.put("name", "良品转坏品");
		w_map.put("img", R.drawable.menu_kc_wbdbck);
		w_list.add(w_map);
...
//		menu.add("m_pad_wbdbck");
	...
	private void turnTo(String menu_type) {
		...
		if ("m_pad_yytbz".equals(menu_type)) {
			...
			DataCache.getinition().setTitle("资产登记信息");
			return;
